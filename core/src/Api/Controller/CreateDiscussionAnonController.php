...
class CreateDiscussionAnonController extends AbstractCreateController
{
    /**
     * {@inheritdoc}
     */
     ...
     * {@inheritdoc}
     */
    protected function data(ServerRequestInterface $request, Document $document, $is_anonymous = 1)
    {
        ...
        $discussion = $this->bus->dispatch(
            new StartDiscussion($actor, Arr::get($request->getParsedBody(), 'data', []), $ipAddress, $is_anonymous)
        );
