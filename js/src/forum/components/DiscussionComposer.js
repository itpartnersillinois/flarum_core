...
export default class DiscussionComposer extends ComposerBody {
  ...
  headerItems() {
    ...
    if (app.history.getCurrent().url == "/public/t/mentoring-group") {
       var anon = document.getElementById("anonButton");
  ...
  onsubmit() {
    ...
    app.store.createRecord('discussionsanon').save(data).then(
      discussion => {
        app.composer.hide();
